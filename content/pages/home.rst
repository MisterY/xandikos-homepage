...
Xandikos in uWSGI. See `examples/uwsgi.ini </code/raw/master/examples/uwsgi.ini>`_ for an
...
`examples/uwsgi-standalone.ini </code/raw/master/examples/uwsgi-standalone.ini>`_.
